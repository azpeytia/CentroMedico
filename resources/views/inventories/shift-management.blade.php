    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <h1 class="display-4">Turnos de inventarios</h1>
                <p class="lead">Seleccione iniciar o finalizar un turno de inventarios</p>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-12 col-md-4 mb-3">
                <form id="startShiftForm">
                    <button type="submit" class="btn btn-success btn-lg w-100" id="btnStartShift" disabled>
                        Iniciar Turno
                    </button>
                </form>
            </div>
            ...
            <div class="col-12 col-md-4 mb-3">
                <form id="endShiftForm">
                    <button type="submit" class="btn btn-danger btn-lg w-100" id="btnEndShift" disabled>
                        Terminar Turno
                    </button>
                </form>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-4 text-center mt-1">
                <form id="inventoryRequestForm">
                    <button type="submit" class="btn btn-info btn-lg w-100" id="btnInventoryRequest" disabled>
                        Requisición
                    </button>
                </form>
            </div>
